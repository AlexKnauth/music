...
(module+ demo
  (require (submod music/data/note/note example)
           music/data/chord/chord
           (submod music/data/instrument/fingering example)
           (submod music/data/instrument/chord-fingering example)))
